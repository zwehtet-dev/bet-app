...
import { AlertDialogContent, type AlertDialogContentProps, AlertDialogPortal, useForwardPropsEmits } from 'radix-vue'
...
const emits = defineEmits<AlertDialogContentProps>()
